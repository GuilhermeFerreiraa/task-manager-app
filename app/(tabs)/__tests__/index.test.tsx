...
const mockTasks: Task[] = [
  {
    ...
    priority: prioritySchemaEnum.HIGH,
    user_id: '123',
  },
  {
    id: '2',
    ...
    status: statusSchemaEnum.COMPLETED,
    priority: prioritySchemaEnum.MEDIUM,
    user_id: '123',
  },
  {
    id: '3',
    ...
    status: statusSchemaEnum.PENDING,
    priority: prioritySchemaEnum.LOW,
    user_id: '123',
  },
];
  ...
  return (
    <View testID="safe-area" style={{ flex: 1 }}>
      <View style={{ flex: 1, marginTop: 20, paddingHorizontal: 20 }}>
        ...
        <Text
          testID="tasks-title"
          style={{ marginTop: 10, fontSize: 22, fontWeight: 'bold', paddingBottom: 4 }}
        >
          Minhas Tarefas
        </Text>
        ...
        <View testID="tasks-list">
          {mockTasks.map((item) => (
            ...
            >
              ...
              <Text
                testID={`task-description-${item.id}`}
